...
function CardSpecials({ data }) {
  return (
    <div className=" mt-10 ">
      <div className="mt-5 text-red-500 text-[8px] md:text-xs flex justify-between border-b-3 border-red-700 pb-1">
        <p>دیری شاپ</p>
      ...
      <div className=" md:px-2 border-l mt-5">
        ...
        <div className="mt-1 md:mt-13">
          <p className="text-[8px] md:text-xs font-normal">{data.name}</p>
          <div className=" text-[8px] md:text-xs mt-5 flex flex-row-reverse justify-between pe-1">
            ...
            <p className="bg-red-500 p-[2px] md:p-1 rounded text-white text-[7px] md:text-xs">
              %
              {Math.round(
          ...
          <p className="text-gray-500 px-3  mt-2 text-end">
            <del className="font-normal text-[7px]  md:text-sm ">
              {FormatNumberInPersian(data.price)}
            </del>
            <span className="font-normal text-[6px] md:text-[10px] ms-1">
              تومان
            </span>
          </p>
        </div>
